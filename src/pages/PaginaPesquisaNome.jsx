...
const PaginaPesquisaNome = () => {
  ...
  const handleAdvancedSearch = (e) => {
    ...
    if (institution) query.push(`institution-name:${institution}`);
    ...
    const buscarPorNome = async () => {
      ...
      try {
        ...
        const lista = data["expanded-result"]?.map(p => {
            ...
            const keywords = (p["keywords"] || []).slice(0, 3).join(", ");
        ...
        setResultados([...comInstituicao, ...semInstituicao]);
  ...
  return (
    ...
    <div>
      ...
      <section className="searchResults">
        ...
        <h2>Resultados para "{nomeBusca}"</h2>
